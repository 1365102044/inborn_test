...
- (UIImage *)cursorWithFontHeight:(CGFloat)height isTop:(BOOL)top {
    ...
    UIColor *color = [UIColor colorWithRed:28.f/255.0 green:107.f/255.0 blue:222.f/255.0 alpha:1.0];
...
- (void)fillSelectionAreaInRect:(CGRect)rect {
    UIColor *bgColor = [UIColor colorWithRed:204.f/255.0 green:221.f/255.0 blue:236.f/255.0 alpha:1.0];
    CGContextRef context = UIGraphicsGetCurrentContext();
