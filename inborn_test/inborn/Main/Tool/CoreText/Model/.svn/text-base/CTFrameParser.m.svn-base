...
+ (CoreTextData *)parseContentArray:(NSArray *)contentArray config:(CTFrameParserConfig*)config
{
    ...
    result = [[self getResultAttributStringWithConfig:config
                                                array:contentArray
                                           imageArray:imageArray
                                            linkArray:linkArray] copy];
    CoreTextData *data = [self parseAttributedContent:result config:config];
...
+ (NSAttributedString *)getResultAttributStringWithConfig:(CTFrameParserConfig *)config
                                                    array:(NSArray *)array
                                               imageArray:(NSMutableArray *)imageArray
                                                linkArray:(NSMutableArray *)linkArray
{
