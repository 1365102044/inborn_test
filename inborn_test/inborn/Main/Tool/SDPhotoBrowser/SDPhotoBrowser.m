...
- (void)setIsHiddenIndexLabelBool:(BOOL)isHiddenIndexLabelBool
{
    if (isHiddenIndexLabelBool) {
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (!_willDisappear) {
        ...
        if ([self.delegate respondsToSelector:@selector(photoBrowserScrollerToindex:)]) {
            [self.delegate photoBrowserScrollerToindex:index + 1];
        }
    }
