...
-(void)zoomPhotoVC{
    ...
    UIWindow *window;
    if ([_handleVC isKindOfClass:[UICollectionViewController class]]) {
        UICollectionViewController *tempController = (UICollectionViewController *)_handleVC;
        window = tempController.collectionView.window;
    }else{
        window = _handleVC.view.window;
    }
