...
- (YBChatViewController *)pushMQChatViewControllerInViewController:(UIViewController *)viewController {
    [self presentOnViewController:viewController transiteAnimation:MQTransiteAnimationTypePush];
    return self.chatViewController;
}

- (YBChatViewController *)presentMQChatViewControllerInViewController:(UIViewController *)viewController {
...
- (YBChatViewController *)createMQChatViewController {
    ...
    return (YBChatViewController *)viewController.topViewController;
}
...
- (UINavigationController *)createNavigationControllerWithWithAnimationSupport:(YBChatViewController *)rootViewController presentedViewController:(UIViewController *)presentedViewController{
...
//修改导航栏属性
- (void)updateNavAttributesWithViewController:(YBChatViewController *)viewController
...
- (YBChatViewController *)chatViewController {
    if (!_chatViewController) {
        _chatViewController = [[YBChatViewController alloc] initWithChatViewManager:chatViewConfig];
    }
