//
//  YBLineSpacingPlaceHolderTextView.m
//  inborn
//
//  Created by 郑键 on 17/5/10.
//  Copyright © 2017年 inborn. All rights reserved.
//

#import "YBLineSpacingPlaceHolderTextView.h"
#import "YBAttributedStringLabel.h"

@interface YBLineSpacingPlaceHolderTextView()
...
@implementation YBLineSpacingPlaceHolderTextView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        paragraphStyle.lineSpacing = self.lineMargin;// 字体的行间距
