...
//    YBGoodsDeatilNaviMoreView *instance = [[YBGoodsDeatilNaviMoreView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
               ...
               clickCellBlcok:(clickTableViewCellBlock)block
{
    ...
    self.height = cellHeight * dataArr.count;
    self.width = width;
    ...
    self.tableView.frame = CGRectMake(0, ADJUST_PERCENT_FLOAT(0),self.backView.width, self.backView.height);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    /**
     详情中 需要 选中色
     */
    if ([_sourVC isKindOfClass:[YBGoodsDeatilViewController class]]) {
        cell.selectedBackgroundView = [[UIView alloc]initWithFrame:cell.frame];
        cell.selectedBackgroundView.backgroundColor = [UIColor colorWithHexString:@"#545867"];
    }else {
...
-(void)dismiss{
    ...
    NSArray *result = [_backView subviews];
    for (UIView *view in result) {
