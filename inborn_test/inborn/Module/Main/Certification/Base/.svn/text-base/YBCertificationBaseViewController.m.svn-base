//
//  YBCertificationBaseViewController.m
//  inborn
//
...
#import "YBCertificationBaseViewController.h"

@interface YBCertificationBaseViewController ()
...
@implementation YBCertificationBaseViewController
